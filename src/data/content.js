...
export const saesY1 = [
  // Réaliser
  {
    ...
    vigilance: 'Au début je confondais encore la logique des boucles et des indices, je m’en suis sorti en pratiquant beaucoup.',
  ...
  },
  {
    ...
    vigilance: 'L’héritage et les interfaces ne m’ont pas paru évidents tout de suite, j’ai mieux compris en testant sur mes propres exemples.',
  ...
  // Optimiser
  {
    ...
    vigilance: 'La partie mathématique m’a vraiment freiné, j’ai dû m’accrocher et avancer étape par étape.',
  ...
  // Administrer
  {
    ...
    vigilance: 'Certaines étapes réseau me sont restées floues sur le moment, je m’en suis sorti avec l’aide de mes camarades.',
  ...
  },
  {
    ...
    vigilance: 'Configurer chaque service au bon endroit n’était pas évident, j’ai avancé en suivant la doc et en testant brique par brique.',
  ...
  // Gérer
  {
    ...
    vigilance: 'Bien modéliser les relations entre les tables m’a demandé plusieurs essais avant que ce soit cohérent.',
    img: 'bdd-1.png',
  ...
  },
  {
    ...
    vigilance: 'Gérer les droits d’accès par rôle était la partie la plus délicate, j’ai pris le temps de bien cadrer les règles.',
    img: 'notes-1.png',
  ...
  // Conduire
  {
    ...
    vigilance: 'J’ai parfois attendu les retours du client, ce qui ralentissait, et du coup tout s’est accéléré à la fin à cause de la deadline.',
  ...
  // Collaborer
  {
    ...
    vigilance: 'Se répartir le travail à plusieurs sur un même site demandait de la coordination, on s’est organisés en se partageant les pages.',
